...
export const siteConfig: SiteConfig = {
	title: "mkの后花园",
	subtitle: "mkの后花园",
	siteURL: "https://mlfk.pages.dev/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-4-20", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/MLFK-MLFK/Mizuki-MLFK",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/308857431",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/MLFK-MLFK",
		},
	],
};
